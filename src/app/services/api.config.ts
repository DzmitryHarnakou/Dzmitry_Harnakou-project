import { ApiUrls } from '../store/models/api-urls'
...
export function getMovieSearchLink (adult:boolean, title:string, overview: string, page: number):string {
...
export function getTvShowSearchLink (title:string, overview: string, page: number):string {
